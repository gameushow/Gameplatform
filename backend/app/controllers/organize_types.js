import OrganizeTypeModel from '../models/organize_type'
...
export const getAll = async (req, res) => {
  ...
  try {
    const data = await OrganizeTypeModel
...
export const create = async (req, res) => {
  ...
  try {
    const result = await OrganizeTypeModel.forge(body).save()
...
export const update = async (req, res) => {
  ...
  try {
    const model = await OrganizeTypeModel.where('id', id).fetch({ require: true })
    model.set(body)
    await model.save()
